...
# 单独处理前三个report的url模板，该url直接指向对应的数据,参数 report + exception
data_url_other = 'http://web.iodp.tamu.edu/limsM/SummaryReportGet-LORE?report={0}&username=guest&password=WsH%2FYEUqqrWDxD15zxsUPg%3D%3D&filters=%5B%22x_expedition%20in%20(%27{1}%27)%22%5D&postretrieve=%7B%22scale_id%22%3A%2211331%22%7D'
# 获取对应表头信息的url模板
